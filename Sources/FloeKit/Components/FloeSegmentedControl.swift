...
struct FloeSegmentedControl_Previews: PreviewProvider {
    struct PreviewContent: View {
        @State private var selectedPill = "Day"
        @State private var selectedUnderline = "All"
        @State private var selectedCard = "Active"
        @State private var selectedIcon = "home"
