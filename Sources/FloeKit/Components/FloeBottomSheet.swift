...
struct FloeBottomSheet_Previews: PreviewProvider {
    ...
    struct BottomSheetPreviewView: View {
        ...
        var body: some View {
            VStack(spacing: 20) {
                Text("FloeBottomSheet Examples")
                    .font(.headline)
                
                if #available(iOS 16.0, macOS 13.0, *) {
                    FloeButton("Show System Bottom Sheet") {
                        showSystemSheet = true
                    }
                }
                
                FloeButton("Show Custom Bottom Sheet") {
            ...
            .background {
                if #available(iOS 16.0, macOS 13.0, *) {
                    FloeBottomSheet(
                        isPresented: $showSystemSheet,
                        detents: [.medium, .large],
                        showDragIndicator: true
                    ) {
                        VStack(spacing: 16) {
                            Text("System Bottom Sheet")
                                .font(.headline)
                            
                            Text("This uses iOS 16+ presentation detents")
